...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        process.env.REACT_APP_EMAILJS_SERVICE_ID || "service_17iz094",
        process.env.REACT_APP_EMAILJS_TEMPLATE_ID || "template_bgriyg8",
        form.current,
        process.env.REACT_APP_EMAILJS_PUBLIC_KEY || "g5lM7VSKmXd5SduH9"
      )
      .then(
        (result) => {
          setOpen(true);
