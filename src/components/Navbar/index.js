  ...
  return (
    <Nav ref={navbarRef}>
      <NavbarContainer>
        ...
        >
          <LogoImg src="/nav-logo.png" alt="logo" />
        ...
        <SocialIconsContainer>
          ...
          <SocialIcon href={Bio.leetcode} target="_blank" rel="noreferrer noopener">
            <SiLeetcode />
          </SocialIcon>
        </SocialIconsContainer>
      ...
      <MobileMenuContainer isOpen={isMobileMenuOpen}>
        ...
        <MobileLinksList>
          ...
          <MobileLink href="#achievements" onClick={handleNavClick}>
            Achievements
          </MobileLink>
        ...
        <MobileSocialIconsContainer>
          ...
          <MobileSocialIcon href={Bio.leetcode} target="_blank" rel="noreferrer noopener">
            <SiLeetcode />
          </MobileSocialIcon>
        </MobileSocialIconsContainer>
      </MobileMenuContainer>
